...
PrepareResult prepare_statement(InputBuffer* input_buffer, Statement* statement){
    if(strncmp(input_buffer->buffer, "insert", 6) == 0){
        ...
        /* Here we must get the address of the int id as scanf requires a pointer to int value
         * We do not need to do the same for the strings as they already have a type of char* */
